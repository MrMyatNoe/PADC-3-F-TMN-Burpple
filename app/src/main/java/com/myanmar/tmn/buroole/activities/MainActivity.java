...
import com.myanmar.tmn.buroole.adapter.ItemBruppleGuidesAdapter;
import com.myanmar.tmn.buroole.adapter.ItemBruppleNewsNTrendingAdapter;
import com.myanmar.tmn.buroole.adapter.ItemBrupplePromotionsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ItemBrupplePromotionsAdapter itemBrupplePromotionsAdapter;

    private ItemBruppleGuidesAdapter itemBruppleGuidesAdapter;

    private ItemBruppleNewsNTrendingAdapter itemBruppleNewsNTrendingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemBrupplePromotionsAdapter = new ItemBrupplePromotionsAdapter();
        ...
        itemBruppleGuidesAdapter= new ItemBruppleGuidesAdapter();
        ...
        itemBruppleNewsNTrendingAdapter = new ItemBruppleNewsNTrendingAdapter();
